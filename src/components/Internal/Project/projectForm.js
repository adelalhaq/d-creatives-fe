...
const Form = (props) => {
  ...
  endDate.setDate(todayDate.getDate() + 21); // Add 30 days

  const dueDateISOString = endDate.toISOString().split("T")[0];
  ...
  const [dueDate, setDueDate] = useState(dueDateISOString);
  ...
  const [project, setProject] = useState(props.project || "Video Editing");
  ...
  return (
    <div className="ps-6 pe-6 mx-auto">
      <form onSubmit={handleSubmit}>
        <div className="flex justify-center mb-4 whitespace-nowrap">
          <div
        ...
        <div className="mt-5 flex justify-center">
          {isLoading ? (
            ...
            <button
              type="submit"
              className="login-btn inline-flex items-center px-4 py-3 "
            >
              Submit
            </button>
          )}
